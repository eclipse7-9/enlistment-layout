from sqlalchemy import Column, Integer, String, ForeignKey, Text, DateTime, Boolean, DECIMAL, Enum, TIMESTAMP
...
class Usuario(Base): 
    ...
    password_usuario = Column(String(100), nullable=False)
    direccion_usuario = Column(String(50), nullable=False)
    codigoPostal_usuario = Column(String(60), nullable=False)  
    imagen_usuario = Column(String(255))
...
class Domicilio(Base):
    ...
    codigoPostal_domicilio = Column(String(60), nullable=False)
...
class Cita(Base):
    ...
    tipo_cita = Column(String(40), nullable=False)
    descripcion_cita = Column(String(255), nullable=False)
    estado_cita = Column(String(30), nullable=False)
...
class Producto(Base):
    ...
    img_producto = Column(String(300))
...
class Recibo(Base):
    ...
    estado_recibo = Column(Enum("emitido", "anulado"), default="emitido")
