...
import os
from routes import usuarios, mascotas, domicilios, servicios, citas, resultados, tratamientos, proveedores, productos, metodo_pago, pedidos, detalle_pedido, recibos, checkout, ubicaciones, notifications
