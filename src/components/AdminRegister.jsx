...
function AdminRegister() {
  const [formData, setFormData] = useState({
    ...
    id_region: "",
    id_ciudad: "",
    admin_key: "",  // Clave para crear administradores
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://127.0.0.1:8000/usuarios/register-admin",
        userData,
        {
          params: {
      ...
      Swal.fire({
        icon: "error",
        title: "Error",
        text: error.response?.data?.detail || "Error al crear el administrador",
        confirmButtonColor: "#7a8358",
      });
    }
  };
                  ...
                  <div className="grid grid-cols-1 gap-6">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm text-gray-500">
                        Esta clave es requerida para crear cuentas de administrador
                      </p>
                    </div>
                  </div>
                  <div className="pt-4">
