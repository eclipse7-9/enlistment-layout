        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li><a href="http://localhost:5173/manual/manual_emprendedor_sphinx.html" target="_blank" rel="noopener noreferrer" className="hover:underline">Manual de usuario</a></li>
