    ...
    <nav className="bg-[#7A8358] text-white shadow-lg fixed w-full z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link
              to="/crear-servicio"
              className="text-white hover:opacity-90 px-3 py-2 rounded-md font-medium bg-gradient-to-r from-[#7a8358] to-[#6b744e] px-4 py-2 rounded-lg shadow-sm"
            >
              Crear Servicio
            </Link>
            <Link to="/crear-servicio-guia" className="text-white hover:opacity-90 px-3 py-2 rounded-md font-medium">Manual de Servicios</Link>
            <Link
              to="/mis-servicios"
      ...
      >
        <div className="px-2 pt-2 pb-3 space-y-1">
          <Link
            to="/crear-servicio"
                className="block text-white hover:opacity-90 px-3 py-2 rounded-md text-base font-medium bg-gradient-to-r from-[#7a8358] to-[#6b744e]"
          >
            Crear Servicio
          </Link>
              <Link
                to="/crear-servicio-guia"
